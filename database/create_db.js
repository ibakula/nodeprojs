...
if (db != null) {
    ...
    db.run("CREATE TABLE users (id INTEGER PRIMATY KEY, first_name TEXT NOT NULL, last_name TEXT NOT NULL, email TEXT NOT NULL UNIQUE, signup_date TEXT NOT NULL, login_date TEXT DEFAULT 0);");
}
